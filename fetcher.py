...
# Almost gave up on this one. Regex sometimes works on IDLE interpreter
...
#  print('Cleaning list of empty values',n)
...
#    print(line)
# file to store failed geocode tries
...
#      new_line = str(list)+address
#      print('  concatenating list with address:',new_line,n)
